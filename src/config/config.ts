export const config = {
  ...
  JWT_CONFIRM_EMAIL_LIFETIME: process.env.JWT_CONFIRM_EMAIL_LIFETIME || '1h',

  JWT_CONFIRM_CASH_SECRET: process.env.JWT_CONFIRM_EMAIL_SECRET || '4234&&34refFSDJNK7sdf$%^',
  JWT_CONFIRM_CASH_LIFETIME: process.env.JWT_CONFIRM_EMAIL_LIFETIME || '24h',
