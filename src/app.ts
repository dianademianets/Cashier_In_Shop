...
import {adminRouter, authRouter, cashRegisterRouter, сashierRouter} from './routes';
...
class App {
    ...
    private mountRoutes(): void {
      ...
      this.app.use('/cashRegister', cashRegisterRouter);
      this.app.use('/cashier', сashierRouter);
